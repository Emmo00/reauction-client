...
export const AUCTION_CONTRACT_ADDRESS = "0xf73Ea33263307A45d73B91a51d9eB99d185025Bc";
export const AUCTION_CONTRACT_ADDRESS_SEPOLIA = "0x803ec9176182B863FD2cD69CF8bC68b1aB1C7b0A";

export const COLLECTIBLE_CONTRACT_ADDRESS = "0xc011Ec7Ca575D4f0a2eDA595107aB104c7Af7A09";
 ...
 */
export const APP_DESCRIPTION = "Reauction farcaster collectibles";

/**
 * The primary category for the mini app.
 * Used for app store categorization and discovery.
 */
export const APP_PRIMARY_CATEGORY = "utility";
 ...
 */
export const APP_OG_IMAGE_URL: string = `${APP_URL}/reauction.png`;
...
export const APP_ACCOUNT_ASSOCIATION: AccountAssociation | undefined = {
  header:
    "eyJmaWQiOjg5MTM2MSwidHlwZSI6ImF1dGgiLCJrZXkiOiIweDcwODUyNjU2N2QyMzVkNjFlZjIwYjNEMkU5MjVGMWU0ODgyNTQ4ZWQifQ",
  payload: "eyJkb21haW4iOiJyZWF1Y3Rpb24ueHl6In0",
  signature:
    "E4mA9sqdEQTlRQ8Ywhq21zaP2OXwZ7cAo76DcwvhCrMHGvEMX/HB5yihngfUZc86wxfj5Gg6GTg+rMCcNHoMRhs=",
};
 ...
 */
export const APP_BUTTON_TEXT = "Reauction Now";
