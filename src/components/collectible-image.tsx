      ...
      >
        ...
        {backgroundMedia && (
          <>
            {isVideo ? (
              ...
              >
                <source src={isUrlEmbed(backgroundMedia) ? backgroundMedia.url : ''} type="video/mp4" />
              </video>
            ) : (
              <img
        ...
        <div 
          style={{
            ...
            lineHeight: 1.4,
            color: '#fff',
            textShadow: backgroundMedia ? '2px 2px 8px rgba(0,0,0,0.8)' : '2px 2px 4px rgba(0,0,0,0.3)',
            wordWrap: 'break-word',
        ...
        >
          <img
            src={castData.author?.pfp_url || `https://api.dicebear.com/7.x/identicon/svg?seed=${castData.author?.username || castData.author?.fid || 'anon'}`}
            alt={`${castData.author?.display_name || castData.author?.username || 'Anonymous'} profile`}
            style={{
              width: `${avatarSize}px`,
...
// <CollectibleImage ref={ref} cast={castResponse} size={1200} />
